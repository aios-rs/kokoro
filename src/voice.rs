...
impl Voice {
    ...
    pub fn from_name(voice_name: &str) -> Self {
        match voice_name {
            // v1.0 voices with default speed 1.0
            "zm_yunyang" => Self::ZmYunyang(1.0),
            "zf_xiaoni" => Self::ZfXiaoni(1.0),
            "af_jessica" => Self::AfJessica(1.0),
            "bf_lily" => Self::BfLily(1.0),
            "zf_xiaobei" => Self::ZfXiaobei(1.0),
            "zm_yunxia" => Self::ZmYunxia(1.0),
            "af_heart" => Self::AfHeart(1.0),
            "bf_emma" => Self::BfEmma(1.0),
            "am_puck" => Self::AmPuck(1.0),
            "bf_alice" => Self::BfAlice(1.0),
            "hf_alpha" => Self::HfAlpha(1.0),
            "bf_isabella" => Self::BfIsabella(1.0),
            "af_nova" => Self::AfNova(1.0),
            "am_fenrir" => Self::AmFenrir(1.0),
            "em_alex" => Self::EmAlex(1.0),
            "im_nicola" => Self::ImNicola(1.0),
            "pm_alex" => Self::PmAlex(1.0),
            "af_alloy" => Self::AfAlloy(1.0),
            "zm_yunxi" => Self::ZmYunxi(1.0),
            "af_sarah" => Self::AfSarah(1.0),
            "jf_nezumi" => Self::JfNezumi(1.0),
            "bm_daniel" => Self::BmDaniel(1.0),
            "jf_tebukuro" => Self::JfTebukuro(1.0),
            "jf_alpha" => Self::JfAlpha(1.0),
            "jm_kumo" => Self::JmKumo(1.0),
            "em_santa" => Self::EmSanta(1.0),
            "am_liam" => Self::AmLiam(1.0),
            "am_santa" => Self::AmSanta(1.0),
            "am_eric" => Self::AmEric(1.0),
            "bm_fable" => Self::BmFable(1.0),
            "af_bella" => Self::AfBella(1.0),
            "bm_lewis" => Self::BmLewis(1.0),
            "pf_dora" => Self::PfDora(1.0),
            "af_nicole" => Self::AfNicole(1.0),
            "bm_george" => Self::BmGeorge(1.0),
            "am_onyx" => Self::AmOnyx(1.0),
            "hm_psi" => Self::HmPsi(1.0),
            "hf_beta" => Self::HfBeta(1.0),
            "hm_omega" => Self::HmOmega(1.0),
            "zf_xiaoxiao" => Self::ZfXiaoxiao(1.0),
            "ff_siwis" => Self::FfSiwis(1.0),
            "ef_dora" => Self::EfDora(1.0),
            "af_aoede" => Self::AfAoede(1.0),
            "am_echo" => Self::AmEcho(1.0),
            "am_michael" => Self::AmMichael(1.0),
            "af_kore" => Self::AfKore(1.0),
            "zf_xiaoyi" => Self::ZfXiaoyi(1.0),
            "jf_gongitsune" => Self::JfGongitsune(1.0),
            "am_adam" => Self::AmAdam(1.0),
            "if_sara" => Self::IfSara(1.0),
            "af_sky" => Self::AfSky(1.0),
            "pm_santa" => Self::PmSanta(1.0),
            "af_river" => Self::AfRiver(1.0),
            "zm_yunjian" => Self::ZmYunjian(1.0),

            // v1.1 voices with default speed 1
            "zm_029" => Self::Zm029(1),
            "zf_048" => Self::Zf048(1),
            "zf_008" => Self::Zf008(1),
            "zm_014" => Self::Zm014(1),
